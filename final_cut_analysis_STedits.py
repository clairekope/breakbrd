...
plt.savefig("Hist_z0_numsubhalos2mpc.png")
plt.clf()
# In[16]:
...
b = axHistx.hist(x_f, bins=binsx, density=True, histtype='step', color='limegreen', lw=2, zorder=2)[-1][0]
c = axHistx.hist(x_c, bins=binsx, density=True, histtype='step', color='b', lw=2, zorder=1)[-1][0]
axHisty.hist(y_p, bins=binsy, density=True, orientation='horizontal', color='lightgray')
axHisty.hist(y_f, bins=binsy, density=True, orientation='horizontal', color='limegreen', lw=2, histtype='step', zorder=2)
axHisty.hist(y_c, bins=binsy, density=True, orientation='horizontal', color='b', lw=2, histtype='step', zorder=1)
...
plt.savefig("Hist_z0_2d_galdens_mstar.png")
plt.clf()
# ## 10^8 Halos in 1 Mpc
